...
//SSL CONFIG
// var key = fs.readFileSync('/root/SSL_Test/ui-key.pem');
// var cert = fs.readFileSync( '/root/SSL_Test/ssl_certificate.cer' );
// var ca = fs.readFileSync( '/root/SSL_Test/IntermediateCA.cer' );
...
// https.createServer(options, app).listen(httpsPort, '172.31.6.19', () => console.log('ADQVest Server listening on port '+httpsPort+'!'));
